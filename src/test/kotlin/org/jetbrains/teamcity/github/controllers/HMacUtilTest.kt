...
class HMacUtilTest {
    ...
    fun testSimpleSignature() {
        doHMacTest(byteArrayOf('x'.toByte()), byteArrayOf('x'.toByte()), "8b6ff74fa7182a90ac20616816f7b8814a429f7c")
        doHMacTest(byteArrayOf('a'.toByte()), byteArrayOf('b'.toByte()), "6657855686823986c874362731139752014cb60b")
        doHMacTest(byteArrayOf('c'.toByte()), byteArrayOf('d'.toByte()), "02c036866544771126771380f2184d40148c4d3c")
    }
